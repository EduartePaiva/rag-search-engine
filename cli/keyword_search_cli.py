...
def main() -> None:
    ...
    tfidf_parser = subparsers.add_parser(
        "tfidf",
        help="Get term frequency invere document frequency from a given ducument id and term",
    )
    tfidf_parser.add_argument("doc_id", type=int, help="Document ID")
    tfidf_parser.add_argument("term", type=str, help="Term to get tfidf for")
    ...
    bm25search_parser.add_argument(
        "limit", type=int, nargs="?", default=DEFAULT_SEARCH_LIMIT, help="Search query"
    )
    ...
    match args.command:
        ...
        case "bm25search":
            ...
            for idx, (movie, score) in enumerate(bm25search, 1):
